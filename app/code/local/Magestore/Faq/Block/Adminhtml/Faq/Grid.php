...
class Magestore_Faq_Block_Adminhtml_Faq_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
      ...
      $collection = Mage::getModel('faq/faq')->getCollection()->setStoreId($store_id);
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('category_id', array(
         'header'    => Mage::helper('faq')->__('Category'),
          ...
          'index'     => 'category_id',
		  'type'      =>'options',
		  'options'   => Mage::helper('faq')->getCategoryOptions1($this->getRequest()->getParam('store')),
      ));
  ...
  {
		$store_id = $this->getRequest()->getParam('store');
      return $this->getUrl('*/*/edit', array('id' => $row->getId(),'store'=>$store_id));
  }
