...
class Webcooking_All_Block_Adminhtml_Wclc extends Webcooking_All_Block_Adminhtml_Text {
    ...
    public function addWclc($lc) {
        $this->addText(base64_decode('PGltZyBzcmM9Imh0dHA6Ly93d3cud2ViLWNvb2tpbmcubmV0L2xpY2VuY2Uv') . $lc . '-' . base64_encode(Mage::getUrl()) . base64_decode('LnBuZyIgd2lkdGg9IjEiIGhlaWdodD0iMSIgLz4='));
    }
}