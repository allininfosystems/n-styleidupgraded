 ...
 */
class Webcooking_ProductRedirection_Block_Adminhtml_Catalog_Product_Edit_Page_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct()
    {
        parent::__construct();
        $this->setId('productredirection_page_grid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            'header'    => Mage::helper('sales')->__('Page Name'),
            'index'     => 'title',
